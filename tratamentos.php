...
<html lang="en">
  ...
  <body id="tratamento">
    ...
    <!-- <header class="masthead">
      <div class="container">
        <div class="intro-text"> -->
          <!-- <div class="intro-lead-in">Cuidadamos de vida...</div> -->
    ...
    <section id="gradiente">
      <div class="container">
        <div class="row" style="margin-top:200px; margin-bottom:118px;" >
          <div class="col-lg-12 col-12 text-center ">
              <h2 class="titulo-inicio">CONHEÇA NOSSOS TRATAMENTOS</h2>
          </div>
        </div>
      </div>
    ...
    <section class="tratamento-gray">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-7"></div>
          <div class="col-lg-4">
            <p>Nefrologia, Diálise e Transplante Renal. A RENALE é uma clínica para tratamento dos pacientes portadores de doenças renais. Realiza atendimentos multiprofissionais em ambulatórios, que contemplam a prevenção e o tratamento das doenças renais, o preparo pré-transplante renal e o seguimento do paciente pós-transplante renal. Também possui uma sala de hemodiálise diferenciada para atendimento de pacientes particulares e convênios.</p>
          </div>
      </div>
    </section>
    ...
    <section class="tratamento-gray">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-10"> <h5 class="topicos">TRATAMENTOS</h5> </div>
        </div>
        <div class="row">
          <div class="col-lg-2"></div>
          <div class="col-lg-8">
            <div class="row align-items-center">
              <div class="col-lg-6 text-center">
                <img src="img/icones/nefro.png" class="img-fluid icones-tratamentos" alt="">
              </div>
              <div class="col-lg-6">
                <h5 class="sub-topicos">Na Hemodialise o paciente conta com um ambinte aconchegante. </h5>
                <p>O procedimento libera o corpo dos resíduos prejudiciais à saúde, como o excesso de sal e de líquidos. Também controla a pressão arterial e ajuda o corpo a manter o equilíbrio de substâncias como sódio, potássio, uréia e creatinina.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-2"></div>
        ...
        <div class="row" style="margin:50px 0px">
          ...
          <div class="col-lg-8">
            <div class="row align-items-center">
              <div class="col-lg-6">
                <h5 class="sub-topicos">Nefrologia é a especialidade médica que se ocupa do diagnóstico e tratamento clínico </h5>
                <p>das doenças do sistema urinário, em especial o rim. Por vezes, essas doenças só afetam os rins mas é necessário sublinhar que, na maior parte dos casos, as doenças que afetam os rins são doenças gerais, como a diabetes Mellitus, a hipertensão arterial e algumas doenças imunológicas, que provocam lesões em vários órgãos e também nos rins.</p>
              </div>
              <div class="col-lg-6 text-center">
                <img src="img/icones/hemo.png" class="img-fluid icones-tratamentos" alt="">
              </div>
            </div>
          </div>
          <div class="col-lg-2"></div>
